...
import { ClipboardList, Warehouse, FileBarChart2 } from "lucide-react";
import { RoleGuard } from "../../components/RoleGuard";
import { PanelNav } from "../../components/panels/PanelNav";
import { STORAGE_NAV_LINKS } from "../../lib/nav-links";

const actions = [
    { href: "/storage/orders", title: "درخواست‌ها", icon: ClipboardList },
    { href: "/storage/dashboard", title: "داشبورد انبار", icon: Warehouse },
    { href: "/storage/reports", title: "گزارش انبار", icon: FileBarChart2 },
];
                    ...
                    <section className="mt-5 grid gap-4 md:grid-cols-3">
                        {actions.map((action) => (
                            ...
                            >
                                ...
                                <h2 className="relative z-10 mt-auto text-2xl font-black text-[#0B2F0B]">{action.title}</h2>
                            </Link>
                        ))}
                    </section>
                </div>
